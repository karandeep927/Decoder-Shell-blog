...
function Home() {
  ...
  return (
    <div>
      <header>
        <div className="bg-primary w-full flex items-center justify-between relative px-4 py-2">
          <div className="flex items-center gap-2">
            <BarsIcon
              className="text-[20px] cursor-pointer sm:hidden text-forth"
      ...
      <main className="w-full min-h-[90vh] bg-second p-3">
        {/* <div className="">
          <HomeSlider/>
        </div> */}
        {/* top section */}
        ...
        <div className="w-full h-[80vh] text-white border border-white">
              slider
        </div>
      </main>
    </div>
